...
public abstract class JavaThreads {
    ...
    /**
     * A thread-local helper object for locking. Must be used only if each {@link Thread}
     * corresponds to an {@link IsolateThread}, otherwise uses
     * {@link Target_java_lang_Thread#lockHelper}.
     */
    ...
    static boolean platformGetAndUpdateInterrupt(Thread thread, boolean newValue) {
        ...
        boolean oldValue = writeInterruptedFlag(thread, newValue);
    ...
    static boolean writeInterruptedFlag(Thread thread, boolean newValue) {
